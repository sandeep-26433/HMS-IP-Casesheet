...
class DoctorAppointments(models.Model):
    ...
    jihva = fields.Selection([('alipta', 'ALIPTA'), ('lipta', 'LIPTA')], string="JIHVA", default='alipta')
    sabdha = fields.Selection([('sama', 'SAMA'), ('asama', 'ASAMA')], string="SABDHA", default='sama')
    sparsha = fields.Selection([('ruksha', 'RUKSHA'), ('snigdha', 'SNIGDHA')], string="SPARSHA", default='ruksha')
    drik = fields.Selection([('sama', 'SAMA'), ('asama', 'ASAMA')], string="DRIK", default='sama')
    akruti = fields.Selection([('lean', 'LEAN'), ('madhyama', 'MADHYAMA'), ('sthula', 'STHULA')], string="AKRUTI")


     # OT Case Sheet Fields
    doa = fields.Date(string="Date of Admission")
    dod = fields.Date(string="Date of Discharge")
    dos = fields.Date(string="Date of Surgery")
    time_of_admission = fields.Datetime(string="Time of Admission")
    time_of_initial_assessment = fields.Datetime(string="Time of Initial Assessment")
    bp = fields.Char(string="Blood Pressure (BP)")
    pulse = fields.Char(string="Pulse")
    temperature = fields.Char(string="Temperature")
    ot_diagnosis = fields.Text(string="Diagnosis")
    ot_remarks = fields.Text(string="Remarks")
    num_treatments_advised = fields.Integer(string="Number of Treatments Advised")
    details_treatments_advised = fields.Text(string="Details of Treatments Advised")
    physiotherapy_advised = fields.Boolean(string="Physiotherapy Advised")
    ot_notes = fields.Text(string="Notes")
    doctor_signature = fields.Char(string="Signature of Doctor")
    diet_notes = fields.Text(string="Diet Notes")
    mild_pain = fields.Selection([('1', '1'), ('2', '2'), ('3', '3')], string="Mild Pain")
    moderate_pain = fields.Selection([('4', '4'), ('5', '5'), ('6', '6')], string="Moderate Pain")
    severe_pain = fields.Selection([('7', '7'), ('8', '8'), ('9', '9'), ('10', '10')], string="Severe Pain")
    daily_progress_analysis = fields.Text(string="Daily Progress Analysis")
    medication_chart = fields.Text(string="Medication (Format:) Date-Medicine-Dosage")
    ip_number = fields.Char(string="IP Number")
    


    @api.onchange('nadi')
    def _onchange_nadi(self):
        """Automatically update 'naadi' when 'nadi' is updated."""
        self.naadi = self.nadi

    @api.onchange('mala')
    def _onchange_mala(self):
        """Automatically update 'maala' when 'mala' is updated."""
        self.maala = self.mala

    @api.onchange('mutra')
    def _onchange_mutra(self):
        """Automatically update 'mutra' when 'mutra' is updated."""
        self.mutra = self.mutra
